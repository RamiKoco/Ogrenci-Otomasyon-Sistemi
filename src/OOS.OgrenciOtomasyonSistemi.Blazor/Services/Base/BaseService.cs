...
namespace OOS.OgrenciOtomasyonSistemi.Blazor.Services.Base;
    ...
    where TDataSource : class, new()
{
    ...
    public string LoadingCaption => L["Lütfen Bekleyin"];
    public string LoadingText => L["Yükleniyor..."];
    ...
    public IStringLocalizer L
    {
        ...
        {
            if (_localizer == null)
                _localizer = StringLocalizerFactory.Create(typeof(OgrenciOtomasyonSistemiResource));

            return _localizer;
        }
    }

    public string BaseReportFolder { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
