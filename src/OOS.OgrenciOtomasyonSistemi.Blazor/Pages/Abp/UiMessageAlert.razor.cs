...
namespace OOS.OgrenciOtomasyonSistemi.Blazor.Pages.Abp;
public partial class UiMessageAlert : ComponentBase, IDisposable
{
    ...
    protected override void OnInitialized()
    {
        ...
        UiMessageService.MessageReceived += OgrenciOtomasyonSistemiReceived;
    }

    private async void OgrenciOtomasyonSistemiReceived(object sender, UiMessageEventArgs e)
    {
