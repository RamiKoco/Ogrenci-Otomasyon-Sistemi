...
using OOS.OgrenciOtomasyonSistemi.Blazor.WebApp.Tiered.Client;
using OOS.OgrenciOtomasyonSistemi.Blazor.WebApp.Tiered.Client.Menus;
using OOS.OgrenciOtomasyonSistemi.Blazor.WebApp.Tiered.Components;
using OOS.OgrenciOtomasyonSistemi.Blazor.WebApp.Tiered.Menus;
...
[DependsOn(
    typeof(OgrenciOtomasyonSistemiHttpApiClientModule),
...
public class OgrenciOtomasyonSistemiBlazorModule : AbpModule
{
    ...
    private void ConfigureCache()
    {
        ...
        {
            options.KeyPrefix = "OgrenciOtomasyonSistemi:";
        });
    }
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles(new BundleFile("/OOS.OgrenciOtomasyonSistemi.Blazor.WebApp.Tiered.Client.styles.css", true));
                }
            );
        });
    }
    ...
    private void ConfigureAuthentication(ServiceConfigurationContext context, IConfiguration configuration)
    {
        context.Services.AddAuthentication(options =>
            ...
            .AddAbpOpenIdConnect("oidc", options =>
            {
                ...
                options.Scope.Add("OgrenciOtomasyonSistemi");
            });
            /*
    ...
    private void ConfigureMenu(IConfiguration configuration)
    {
        ...
        {
            options.MenuContributors.Add(new OgrenciOtomasyonSistemiMenuContributor(configuration));
        });

        Configure<AbpToolbarOptions>(options =>
        {
            options.Contributors.Add(new OgrenciOtomasyonSistemiToolbarContributor());
        });
    }
    ...
    private void ConfigureRouter(ServiceConfigurationContext context)
    {
        Configure<AbpRouterOptions>(options =>
        {
            ...
            options.AdditionalAssemblies.Add(typeof(OgrenciOtomasyonSistemiBlazorClientModule).Assembly);
        });
    }
    ...
    {
        var dataProtectionBuilder = context.Services.AddDataProtection().SetApplicationName("OgrenciOtomasyonSistemi");
        if (!hostingEnvironment.IsDevelopment())
        {
            var redis = ConnectionMultiplexer.Connect(configuration["Redis:Configuration"]!);
            dataProtectionBuilder.PersistKeysToStackExchangeRedis(redis, "OgrenciOtomasyonSistemi-Protection-Keys");
        }
    }
