...
{
    [DbContext(typeof(OgrenciOtomasyonSistemiDbContext))]
    [Migration("20250919064035_Parametreler")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OOS.OgrenciOtomasyonSistemi.Donemler.Donem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OOS.OgrenciOtomasyonSistemi.Ogrenciler.Ogrenci", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<short>("KanGrubu")
                        .HasColumnType("smallint");

                    b.Property<DateTime>("KimlikGT")
                        .HasColumnType("date");
                    ...
                    b.ToTable("AppOgrenciler", (string)null);
                });

            modelBuilder.Entity("OOS.OgrenciOtomasyonSistemi.Ogretmenler.Ogretmen", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppOgretmenler", (string)null);
                });

            modelBuilder.Entity("OOS.OgrenciOtomasyonSistemi.Okullar.Okul", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppOkullar", (string)null);
                });

            modelBuilder.Entity("OOS.OgrenciOtomasyonSistemi.OzelKodlar.OzelKod", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OOS.OgrenciOtomasyonSistemi.Parametreler.FirmaParametre", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OOS.OgrenciOtomasyonSistemi.Ogrenciler.Ogrenci", b =>
                {
                    b.HasOne("OOS.OgrenciOtomasyonSistemi.OzelKodlar.OzelKod", "OzelKod1")
                        .WithMany("OzelKod1Ogrenciler")
                        .HasForeignKey("OzelKod1Id")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("OOS.OgrenciOtomasyonSistemi.OzelKodlar.OzelKod", "OzelKod2")
                        .WithMany("OzelKod2Ogrenciler")
            ...
            modelBuilder.Entity("OOS.OgrenciOtomasyonSistemi.Ogretmenler.Ogretmen", b =>
                {
                    b.HasOne("OOS.OgrenciOtomasyonSistemi.OzelKodlar.OzelKod", "OzelKod1")
                        .WithMany("OzelKod1Ogretmenler")
                        .HasForeignKey("OzelKod1Id")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("OOS.OgrenciOtomasyonSistemi.OzelKodlar.OzelKod", "OzelKod2")
                        .WithMany("OzelKod2Ogretmenler")
                        .HasForeignKey("OzelKod2Id")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("OOS.OgrenciOtomasyonSistemi.Okullar.Okul", b =>
                {
                    b.HasOne("OOS.OgrenciOtomasyonSistemi.OzelKodlar.OzelKod", "OzelKod1")
                        .WithMany("OzelKod1Okullar")
                        .HasForeignKey("OzelKod1Id")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("OOS.OgrenciOtomasyonSistemi.OzelKodlar.OzelKod", "OzelKod2")
                        .WithMany("OzelKod2Okullar")
                        .HasForeignKey("OzelKod2Id")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("OOS.OgrenciOtomasyonSistemi.Parametreler.FirmaParametre", b =>
                {
                    b.HasOne("OOS.OgrenciOtomasyonSistemi.Donemler.Donem", "Donem")
                        .WithMany("FirmaParametreler")
                        .HasForeignKey("DonemId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("OOS.OgrenciOtomasyonSistemi.Okullar.Okul", "Okul")
                    ...
                    b.HasOne("Volo.Abp.Identity.IdentityUser", "User")
                        .WithOne()
                        .HasForeignKey("OOS.OgrenciOtomasyonSistemi.Parametreler.FirmaParametre", "UserId")
            ...
            modelBuilder.Entity("OOS.OgrenciOtomasyonSistemi.OzelKodlar.OzelKod", b =>
                {
                    b.Navigation("OzelKod1Ogrenciler");

                    b.Navigation("OzelKod1Ogretmenler");

                    b.Navigation("OzelKod1Okullar");

                    b.Navigation("OzelKod2Ogrenciler");

                    b.Navigation("OzelKod2Ogretmenler");

                    b.Navigation("OzelKod2Okullar");
                });
