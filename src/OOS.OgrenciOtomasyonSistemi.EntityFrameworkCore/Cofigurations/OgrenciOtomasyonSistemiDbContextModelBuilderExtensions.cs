...
public static class OgrenciOtomasyonSistemiDbContextModelBuilderExtensions
{
    ...
    public static void ConfigureSube(this ModelBuilder builder)
    {
        ...
        {
            b.ToTable(OgrenciOtomasyonSistemiConsts.DbTablePrefix + "Subeler", OgrenciOtomasyonSistemiConsts.DbSchema);
            b.ConfigureByConvention();
    ...
    public static void ConfigureImage(this ModelBuilder builder)
    {
        ...
        {
            b.ToTable(OgrenciOtomasyonSistemiConsts.DbTablePrefix + "Images", OgrenciOtomasyonSistemiConsts.DbSchema);
            b.ConfigureByConvention();
