...
[Authorize]
public class FirmaParametreAppService : OgrenciOtomasyonSistemiAppService, IFirmaParametreAppService
{
    ...
    {
        await _firmaParametreManager.CheckCreateAsync(input.OkulId, input.DonemId);
    ...
    {
        await _firmaParametreManager.CheckUpdateAsync(input.OkulId, input.DonemId);
