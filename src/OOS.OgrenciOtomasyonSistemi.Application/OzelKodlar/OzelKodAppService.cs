...
[Authorize(OgrenciOtomasyonSistemiPermissions.OzelKod.Default)]
public class OzelKodAppService : OgrenciOtomasyonSistemiAppService, IOzelKodAppService
{
    ...
    [Authorize(OgrenciOtomasyonSistemiPermissions.OzelKod.Create)]
    ...
    [Authorize(OgrenciOtomasyonSistemiPermissions.OzelKod.Update)]
    ...
    [Authorize(OgrenciOtomasyonSistemiPermissions.OzelKod.Delete)]
