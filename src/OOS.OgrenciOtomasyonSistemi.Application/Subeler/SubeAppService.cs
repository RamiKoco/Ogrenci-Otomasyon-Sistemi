...
[Authorize(OgrenciOtomasyonSistemiPermissions.Sube.Default)]
public class SubeAppService : OgrenciOtomasyonSistemiAppService, ISubeAppService
{
    ...
    [Authorize(OgrenciOtomasyonSistemiPermissions.Sube.Create)]
    ...
    [Authorize(OgrenciOtomasyonSistemiPermissions.Sube.Update)]
    ...
    [Authorize(OgrenciOtomasyonSistemiPermissions.Sube.Delete)]
