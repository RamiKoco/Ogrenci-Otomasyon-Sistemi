...
[Authorize(OgrenciOtomasyonSistemiPermissions.Image.Default)]
public class ImageAppService : OgrenciOtomasyonSistemiAppService, IImageAppService
{
    ...
    [Authorize(OgrenciOtomasyonSistemiPermissions.Image.Create)]
    ...
    [Authorize(OgrenciOtomasyonSistemiPermissions.Image.Update)]
    ...
    [Authorize(OgrenciOtomasyonSistemiPermissions.Image.Delete)]
