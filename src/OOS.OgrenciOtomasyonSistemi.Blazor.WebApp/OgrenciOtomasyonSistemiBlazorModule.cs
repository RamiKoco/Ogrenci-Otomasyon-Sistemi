...
using OOS.OgrenciOtomasyonSistemi.Blazor.WebApp.Client;
using OOS.OgrenciOtomasyonSistemi.Blazor.WebApp.Client.Menus;
using OOS.OgrenciOtomasyonSistemi.Blazor.WebApp.Components;
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles(new BundleFile("/OOS.OgrenciOtomasyonSistemi.Blazor.WebApp.Client.styles.css", true));
                }
            );
        });
    }
