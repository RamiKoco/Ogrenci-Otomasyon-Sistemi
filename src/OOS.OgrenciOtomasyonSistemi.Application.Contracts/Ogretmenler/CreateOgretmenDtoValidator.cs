...
public class CreateOgretmenDtoValidator : AbstractValidator<CreateOgretmenDto>
{
    public CreateOgretmenDtoValidator(IStringLocalizer<OgrenciOtomasyonSistemiResource> localizer)
    {
        RuleFor(x => x.Kod)
        .NotEmpty()
