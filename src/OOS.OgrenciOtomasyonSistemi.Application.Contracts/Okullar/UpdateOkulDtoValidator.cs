...
public class UpdateOkulDtoValidator : AbstractValidator<UpdateOkulDto>
{
    public UpdateOkulDtoValidator(IStringLocalizer<OgrenciOtomasyonSistemiResource> localizer)
    {
        RuleFor(x => x.Kod)
          .NotEmpty()
