...
[Authorize(OnMuhasebePermissions.Ogrenci.Default)]
public class OgrenciAppService : OnMuhasebeAppService, IOgrenciAppService
{
    ...
    [Authorize(OnMuhasebePermissions.Ogrenci.Create)]
    ...
    [Authorize(OnMuhasebePermissions.Ogrenci.Update)]
    ...
    [Authorize(OnMuhasebePermissions.Ogrenci.Delete)]
