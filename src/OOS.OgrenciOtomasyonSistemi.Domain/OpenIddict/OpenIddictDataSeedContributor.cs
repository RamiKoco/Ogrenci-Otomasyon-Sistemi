...
namespace OOS.OgrenciOtomasyonSistemi.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("OgrenciOtomasyonSistemi") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "OgrenciOtomasyonSistemi", DisplayName = "OgrenciOtomasyonSistemi API", Resources = { "OgrenciOtomasyonSistemi" }
            });
        }
    }
